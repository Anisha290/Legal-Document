...
# API_KEY = "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"
...
#     return full_summary, accuracy

# # Home route for file upload and summary generation
# @app.route('/', methods=['GET', 'POST'])
# def index():
#     if request.method == 'POST':
#         file = request.files['file']
...
#             # Generate Summary
#             summary, accuracy = generate_summary(document_content, file.filename)
...
# # Route for downloading summary as TXT or PDF
# @app.route('/download', methods=['POST'])
# def download():
#     summary = request.form['summary']
#     file_type = request.form['file_type']
